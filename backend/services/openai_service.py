...
async def generate_chat_stream(
    ...
    """
    Streams live LLM responses from Groq (or OpenAI) if GROQ_API_KEY is configured,
    or falls back gracefully to educational mock streaming.
    """
    ...
    if client:
        try:
            ...
            error_msg = f"\n\n*Error generating response from Groq LLM Provider: {str(e)}*"
            yield error_msg
    else:
